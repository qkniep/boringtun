...
pub const PQ_PUBLIC_KEY_SIZE: usize = 1088;
pub const PQ_CIPHERTEXT_SIZE: usize = 1152;
pub const PQ_SHARED_KEY_SIZE: usize = 32;

#[link(name = "oqs")]
extern {
    #[link_name = "OQS_KEM_kyber_768_cca_kem_keypair"]
    pub fn pq_keypair(public_key: *mut u8,
                      secret_key: *mut u8);
    #[link_name = "OQS_KEM_kyber_768_cca_kem_encaps"]
    pub fn pq_encaps(ciphertext: *mut u8,
                     shared_secret: *mut u8,
                     public_key: *const u8);
    #[link_name = "OQS_KEM_kyber_768_cca_kem_decaps"]
